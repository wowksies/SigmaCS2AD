// api/user/status.js — Dashboard data for the logged-in user
// Returns account info, key status, time remaining, etc.
const {
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (user.activeKey && user.activeKey.keyId) {
      // Fetch fresh key data from Firebase
